...
function RayfieldLibrary:CreateWindow(Settings) --Name = "Phantom Forces", SaveConfiguration = true, ConfigurationFolder = "PhantomForces" (defaults to placeid)
	...
	for _, TabButton in ipairs(TabList:GetChildren()) do
		if TabButton.ClassName == "Frame" then
	...
	function Window:CreateTab(Name)
		...
		TabButton.Size = UDim2.new(0, TabButton.Title.TextBounds.X + 30, 1, 0)
		...
		TabButton.Interact.MouseButton1Click:Connect(function()
			...
			for _, OtherTabButton in ipairs(TabList:GetChildren()) do
				if OtherTabButton.Name ~= "Template" and OtherTabButton.ClassName == "Frame" and OtherTabButton ~= TabButton then
